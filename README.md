...
1. Paste a [IIIF manifest](https://iiif.io/get-started/how-iiif-works/) URL from any library or archive
2. [Tesseract.js](https://tesseract.projectnaptha.com/) OCR identifies words on each scanned page
3. Words are randomly cut out, revealing the pages beneath

The result is a layered visual composition in the style of cut-page artists' books.
...
[<img src="examples/the-life-of-samuel-johnson-4.png">](examples/the-life-of-samuel-johnson-4.png)
